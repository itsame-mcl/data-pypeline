...
class TestRound(unittest.TestCase):
    def setUp(self):
        self.df = DataFrame({'Cat': ["A", "A", "A", "B", "B", "B", "B", "C", "C", "C"],
                             ...
                             'Var1': [10.123, 14.2634, 13.9122, 22.74, 28.09, 23.1, 30, 6.06, 8.57, 9.532],
    ...
    def test_round(self):
        ...
        self.assertEqual([10.12, 14.26, 13.91, 22.74, 28.09, 23.1, 30, 6.06, 8.57, 9.53], result[2])
    ...
    def test_round_as_numeric(self):
        ...
        self.assertEqual([5, 8, -1, 0, 7, 11, -8, 5, -4, 9], result[6])
